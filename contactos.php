...
$query = "SELECT cat.nombre AS nombrecategoria, 
    con.id AS id, con.nombre AS nombre, con.apellido AS apellido, 
    con.telefono AS telefono, con.email AS email, 
    con.categoria AS categoria_id FROM categorias cat 
    INNER JOIN contactos con ON con.categoria = cat.id";
...
<div class="row">
    ...
    <div class="col-sm-4 offset-2">
        <a href="crear_contacto.php" class="btn btn-success w-100"><i class="bi bi-plus-circle-fill"></i> Nuevo
            Contacto</a>
    </div>
</div>
